const CartSummary = ({ totalQuantity, totalPrice, onClearSelection }) => {
    ...
    return (
        <div className="mx-auto p-4 mt-4 bg-black opacity-80 text-white rounded-lg">
            <div className="flex justify-between items-center p-4 border-b border-gray-600">
                ...
                <button 
                    className="bg-white font-semibold text-black px-4 py-2 rounded-lg hover:opacity-80 transition"
